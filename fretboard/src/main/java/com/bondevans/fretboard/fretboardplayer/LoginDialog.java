...
//        Button register;
        ...
        pwd = (EditText) layout.findViewById(R.id.password);
...
//        register = (Button) layout.findViewById(R.id.registerButton);
...
//                } else {
//                    loginListener.OnRegistrationDetailsEntered(email.getText().toString().trim(),
